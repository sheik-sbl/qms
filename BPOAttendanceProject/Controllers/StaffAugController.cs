...
{
     [UserFilter]
    public class StaffAugController : Controller
    {

        #region Additionalinfo


         public ActionResult GetStaffAugViewDetails(string ID)
        {
            int Id = Convert.ToInt16(ID);
            StaffAugServices Model = new StaffAugServices();
            string connString = ConfigurationManager.ConnectionStrings["MySQLConnString"].ConnectionString;
            string Command = "SELECT id,internalbilling,externalbilling, Resources,Attrition,BillsInternal,notbilled,Total,etoininr,etoinusd,month,year,bestperformer,`Idlehrs` from `StaffAugService` where StaffAugService.id=" + Id;
            ...
            return PartialView("/Views/StaffAug/_ViewStaffAugService.cshtml", Model);
        }
        ...
        public ActionResult GetAdditionalInfo(string ID)
        {
            int Id = Convert.ToInt16(ID);
            StaffAugServices Model = new StaffAugServices();
            string connString = ConfigurationManager.ConnectionStrings["MySQLConnString"].ConnectionString;
            ...
            return PartialView("/Views/StaffAug/_AddAdditionalInfo.cshtml", Model);
        }

        public ActionResult StaffAugServices()
        {
            StaffAugServices Model = new StaffAugServices();
            string connString = ConfigurationManager.ConnectionStrings["MySQLConnString"].ConnectionString;
            string Command = "SELECT id as Id, month,year,internalbilling,externalbilling, Resources,`etoininr`,etoinusd from `StaffAugService`";
            using (MySqlConnection mConnection = new MySqlConnection(connString))
            {
                mConnection.Open();
                ...
                Model.LstStaffAugServices = dtt.DataTableToList<StaffAugServices>();
        ...
        public ActionResult AddStaffAugservice()
        {
            StaffAugServices model = new StaffAugServices();

            return PartialView("_AddAdditionalInfo", model);

        }

        public int StaffAugServiceExistence(StaffAugServices model)
        {
            int Result = 0;
            string connString = ConfigurationManager.ConnectionStrings["MySQLConnString"].ConnectionString;
            string Command = "SELECT count(*) as cnt FROM `StaffAugService` where month='" + model.Month + "' and `year`='" + model.Year + "'";
            using (MySqlConnection mConnection = new MySqlConnection(connString))
            {
                mConnection.Open();
                MySqlCommand cmd = new MySqlCommand(Command, mConnection);
        ...
        public ActionResult SaveAdditionalInfo(StaffAugServices model)
        {
            if (ModelState.IsValid)
            {
                if (model.Id == 0)
                {
                    int insertresult = StaffAugServiceExistence(model);
                    if (insertresult == 0)
                    {
                        string Result = ManageStaffAugService(model);
                        if (Result.Trim('"') == "Ok")
            ...
            return RedirectToAction("StaffAugServices");

        }


        public string ManageStaffAugService(StaffAugServices model)
        {
            ...
            if (model.Id == 0)
            {
                Command = "INSERT INTO `StaffAugService` (`month`,`year`, `internalbilling`,`externalbilling`,`Total`,etoininr,etoinusd,`Resources`,`Attrition`,`BillsInternal`,`notbilled`,bestperformer,`Idlehrs`) VALUES ('" + model.Month + "','" + model.Year + "'," + model.internalbilling + " ," + model.externalbilling + "," + model.Total + "," + model.etoinINR + "," + model.etoinUSD + "," + model.Resources + ",'" + model.Attrition + "'," + model.billedincluded + "," + model.notbilled + ",'" + model.bestperformer + "'," + model.idlehrs + ");";
                using (MySqlConnection mConnection = new MySqlConnection(connString))
                {
                    mConnection.Open();
            ...
            else
            {
                ...
                Command = "UPDATE StaffAugService set  `internalbilling`=" + model.internalbilling + ",externalbilling=" + model.externalbilling + ",Total=" + model.Total + ", etoininr=" + model.etoinINR + ",etoinusd=" + model.etoinUSD + ", Resources =" + model.Resources + ",Attrition='" + model.Attrition + "',BillsInternal=" + model.billedincluded + ",notbilled=" + model.notbilled + ", month='" + model.Month + "', year='" + model.Year + "',bestperformer='" + model.bestperformer + "',Idlehrs=" + model.idlehrs + " where StaffAugService.Id=" + model.Id;
                using (MySqlConnection mConnection = new MySqlConnection(connString))
                {
                    mConnection.Open();
                    using (MySqlCommand myCmd = new MySqlCommand(Command, mConnection))
        ...
        public string DeleteServiceDetails(string ID)
        {
            ...
            using (MySqlConnection mConnection = new MySqlConnection(connString))
            {
                ...
                cmd.CommandText = "delete from `StaffAugService` where `StaffAugService`.id=" + Id;
                cmd.ExecuteNonQuery();
                cmd.Dispose();
                Result = "1";
            }
            return Result;
             ...
             #region  MonthlyStaffAugservice

             public ActionResult MonthlyStaffAugservice()
             {
                 MonthlyStaffAugservice Model = new MonthlyStaffAugservice();
                 string connString = ConfigurationManager.ConnectionStrings["MySQLConnString"].ConnectionString;
                 //string Command = "SELECT  id as Id ,month,year,budgeINR,ActualINR from `monthlyGisservice`";
                 string Command = "SELECT id as Id, month,year,budgeINR,ActualINR,yyyy, mm, cbacklog, (cbacklog + ( SELECT SUM(ActualINR-budgeINR) FROM `monthlyStaffAugservice`  WHERE date >= STR_TO_DATE(CONCAT_WS('-', yyyy, mm, 1),'%Y-%c-%e') - INTERVAL 1 MONTH AND   date <  STR_TO_DATE(CONCAT_WS('-', yyyy, mm, 1),'%Y-%c-%e')))  AS cumbacklog FROM (SELECT id as Id, month,year,budgeINR,ActualINR, EXTRACT(YEAR FROM date) AS yyyy, EXTRACT(MONTH FROM date) AS mm, SUM(ActualINR-budgeINR) AS cbacklog FROM `monthlyStaffAugservice` GROUP BY EXTRACT(YEAR FROM date), EXTRACT(MONTH FROM date)) AS x ORDER BY yyyy, mm";
                 ...
                 using (MySqlConnection mConnection = new MySqlConnection(connString))
                 {
                     ...
                     adapter.Fill(ds.Tables[0]);
                     DataTable dtt = ds.Tables[0];
                     Model.LstMonthlyStaffAugservice = dtt.DataTableToList<MonthlyStaffAugservice>();
                     return View("MonthlyStaffAugservice", Model);
                 }


             }

             public ActionResult AddmonthlyStaffAugservice()
             {
                 MonthlyStaffAugservice model = new MonthlyStaffAugservice();

                 return PartialView("_AddStaffAugService", model);

             }



             public ActionResult SaveStaffAugservice(MonthlyStaffAugservice model)
             {
                 if (ModelState.IsValid)
                 {
                     if (model.Id == 0)
                     {
                         int insertresult = MonthlyStaffAugServiceExistence(model);
                         if (insertresult == 0)
                         {
                             string Result = ManageStaffAugService(model);
                             if (Result.Trim('"') == "Ok")
                 ...
                 return RedirectToAction("MonthlyStaffAugService");

             }


             public string ManageStaffAugService(MonthlyStaffAugservice model)
             {
                 string Result = string.Empty;
                 Result = "NotOk";
                 string connString = ConfigurationManager.ConnectionStrings["MySQLConnString"].ConnectionString;
                 ...
                 if (model.Id == 0)
                 {
                     Command = "INSERT INTO monthlyStaffAugservice(`month`,`year`, `budgeINR`,`ActualINR`,date) VALUES ('" + model.Month + "','" + model.Year + "'," + model.budgeINR + "," + model.ActualINR + " ,'" + Date1 + "');";
                     using (MySqlConnection mConnection = new MySqlConnection(connString))
                     {
                         mConnection.Open();
                         using (MySqlCommand myCmd = new MySqlCommand(Command, mConnection))
                 ...
                 else
                 {
                     ...
                     Command = "UPDATE monthlyStaffAugservice set `budgeINR`='" + model.budgeINR + "', `ActualINR`='" + model.ActualINR + "',month='" + model.Month + "',Year='" + model.Year + "',date='" + Date1 + "' where monthlyStaffAugservice.id=" + model.Id;
                     using (MySqlConnection mConnection = new MySqlConnection(connString))
                     {
                         mConnection.Open();
                         using (MySqlCommand myCmd = new MySqlCommand(Command, mConnection))
             ...
             public int MonthlyStaffAugServiceExistence(MonthlyStaffAugservice model)
             {
                 int Result = 0;
                 string connString = ConfigurationManager.ConnectionStrings["MySQLConnString"].ConnectionString;
                 string Command = "SELECT count(*) as cnt FROM `monthlyStaffAugservice` where month='" + model.Month + "' and `year`='" + model.Year + "'";
                 using (MySqlConnection mConnection = new MySqlConnection(connString))
                 {
                     mConnection.Open();
                     MySqlCommand cmd = new MySqlCommand(Command, mConnection);
             ...
             public ActionResult GetStaffAugService(string ID)
             {
                 int Id = Convert.ToInt16(ID);
                 MonthlyStaffAugservice Model = new MonthlyStaffAugservice();
                 string connString = ConfigurationManager.ConnectionStrings["MySQLConnString"].ConnectionString;
                 string Command = "SELECT id,month,year,budgeINR,ActualINR FROM monthlyStaffAugservice where monthlyStaffAugservice.id=" + Id;
                 using (MySqlConnection mConnection = new MySqlConnection(connString))
                 {
                     mConnection.Open();
                     MySqlCommand cmd = new MySqlCommand(Command, mConnection);
                 ...
                 return PartialView("/Views/StaffAug/_AddStaffAugService.cshtml", Model);
             }

             public ActionResult DeleteStaffAugservice(string ID)
             {
                 try
                 {
                     DeleteStaffAugserviceDetails(ID);
                     TempData["Msg"] = "Successfully Deleted";
                     return RedirectToAction("MonthlyStaffAugservice");
                 }
                 catch (Exception)
             ...
             public string DeleteStaffAugserviceDetails(string ID)
             {
                 int Id = int.Parse(ID);
                 string Result = "0";
                 string connString = ConfigurationManager.ConnectionStrings["MySQLConnString"].ConnectionString;
                 using (MySqlConnection mConnection = new MySqlConnection(connString))
                 {
                     ...
                     MySqlCommand cmd = new MySqlCommand();
                     cmd.Connection = mConnection;
                     cmd.CommandText = "delete from monthlyStaffAugservice where monthlyStaffAugservice.id=" + Id;
                     cmd.ExecuteNonQuery();
                     cmd.Dispose();
                     Result = "1";
                 }
             ...
             public ActionResult BarChart(string month,string year)
             {
                 ...
                 string backlogcommand = "select  sum(ActualINR)-  sum(budgeINR) as backlog from monthlyStaffAugservice where date >='" + dfromdate + "' and date <='" + denddate + "'";
                 ...
                 Command = "select concat ( month,year) as monthyear, budgeINR as BudgetINR,ActualINR,CEIL((ActualINR/budgeINR)*100) as Percent  from monthlyStaffAugservice where monthlyStaffAugservice.month='" + month + "'  and  monthlyStaffAugservice.year=" + year + "";
             ...
             {
                 MonthlyStaffAugTarget Model = new MonthlyStaffAugTarget();
                 string connString = ConfigurationManager.ConnectionStrings["MySQLConnString"].ConnectionString;
                 string Command = "SELECT  id as Id ,month,year,target from `monthlystaffAugTarget`";
                 using (MySqlConnection mConnection = new MySqlConnection(connString))
                 {
                     mConnection.Open();
                     MySqlDataAdapter adapter = new MySqlDataAdapter(Command, mConnection);
                     ...
                     adapter.Fill(ds.Tables[0]);
                     DataTable dtt = ds.Tables[0];
                     Model.LstMonthlyStaffAugTarget = dtt.DataTableToList<MonthlyStaffAugTarget>();
             ...
             public ActionResult SaveRevenueplan(MonthlyStaffAugTarget model)
             {
                 if (ModelState.IsValid)
                 {
                     if (model.Id == 0)
             ...
             public string ManageRevenueplan(MonthlyStaffAugTarget model)
             {
                 string Result = string.Empty;
                 Result = "NotOk";
                 string connString = ConfigurationManager.ConnectionStrings["MySQLConnString"].ConnectionString;
                 ...
                 if (model.Id == 0)
                 {
                     Command = "INSERT INTO `monthlystaffAugTarget`(`month`,`year`, `target`) VALUES ('" + model.Month + "','" + model.Year + "'," + model.target + ");";
                     using (MySqlConnection mConnection = new MySqlConnection(connString))
                     {
                         mConnection.Open();
                         using (MySqlCommand myCmd = new MySqlCommand(Command, mConnection))
                 ...
                 else
                 {
                     ...
                     Command = "UPDATE `monthlystaffAugTarget` set `target`=" + model.target + ",month='" + model.Month + "',Year='" + model.Year + "' where `monthlystaffAugTarget`.`id`=" + model.Id;
                     using (MySqlConnection mConnection = new MySqlConnection(connString))
                     {
                         mConnection.Open();
                         using (MySqlCommand myCmd = new MySqlCommand(Command, mConnection))
             ...
             public int RevenueplanExistence(MonthlyStaffAugTarget model)
             {
                 int Result = 0;
                 string connString = ConfigurationManager.ConnectionStrings["MySQLConnString"].ConnectionString;
                 string Command = "SELECT count(*) as cnt FROM `monthlystaffAugTarget` where month='" + model.Month + "' and `year`='" + model.Year + "'";
                 using (MySqlConnection mConnection = new MySqlConnection(connString))
                 {
                     mConnection.Open();
                     MySqlCommand cmd = new MySqlCommand(Command, mConnection);
             ...
             public ActionResult GetRevenuePlan(string ID)
             {
                 ...
                 MonthlyStaffAugTarget Model = new MonthlyStaffAugTarget();
                 string connString = ConfigurationManager.ConnectionStrings["MySQLConnString"].ConnectionString;
                 string Command = "SELECT id,month,year,target FROM `monthlystaffAugTarget` where `monthlystaffAugTarget`.id=" + Id;
                 using (MySqlConnection mConnection = new MySqlConnection(connString))
                 {
                     mConnection.Open();
                     MySqlCommand cmd = new MySqlCommand(Command, mConnection);
                 ...
                 return PartialView("/Views/StaffAug/_AddRevenueplan.cshtml", Model);
             }
             ...
             public string DeleteRevenuePlanDetails(string ID)
             {
                 ...
                 using (MySqlConnection mConnection = new MySqlConnection(connString))
                 {
                     ...
                     MySqlCommand cmd = new MySqlCommand();
                     cmd.Connection = mConnection;
                     cmd.CommandText = "delete from `monthlystaffAugTarget` where `monthlystaffAugTarget`.id=" + Id;
                     cmd.ExecuteNonQuery();
                     cmd.Dispose();
                     Result = "1";
                 }
